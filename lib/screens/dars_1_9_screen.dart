...
class Dars119Screen extends StatefulWidget {
  ...
  @override
  State<Dars119Screen> createState() => _Dars119ScreenState();
}

class _Dars119ScreenState extends State<Dars119Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    final progress = app.dars119Progress(Dars119.selfAssessItems.length);
          ...
          title: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('الدرس التاسع — الأخلاق في الأسرة والمجتمع', style: TextStyle(fontSize: 17)),
              ],
            ),
          ),
          actions: [
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'بحمد الله وتوفيقه تم الدرس التاسع',
                                      ...
                                      children: [
                                        ElevatedButton.icon(
                                          onPressed: () => CelebrationDialog.show(
                                            context,
                                            title: 'أَحْسَنْتَ! 🎉',
                                            message: 'أَتْمَمْتَ الدَّرْسَ التَّاسِعَ: الْأَخْلَاقُ فِي الْأُسْرَةِ وَالْمُجْتَمَعِ',
                                          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('الأَخْلَاقُ فِي الأُسْرَةِ وَالمُجْتَمَعِ',

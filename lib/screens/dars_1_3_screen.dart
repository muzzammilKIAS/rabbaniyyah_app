...
import '../widgets/dars_1_3/analyze_card.dart';
import '../widgets/dars_1_3/reading_card.dart';
import '../widgets/dars_1_3/reflection_exit_card.dart';
import '../widgets/dars_1_3/rule_card.dart';
import '../widgets/dars_1_3/speaking_card.dart';
import '../widgets/dars_1_3/think_write_card.dart';
import '../widgets/dars_1_3/vocab_card.dart';
...
class Dars113Screen extends StatefulWidget {
  ...
  @override
  State<Dars113Screen> createState() => _Dars113ScreenState();
}

class _Dars113ScreenState extends State<Dars113Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    final progress = app.dars113Progress(Dars113.selfAssessItems.length);
        ...
        appBar: AppBar(
          ...
          title: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('الفصل الأول ‹ الوحدة الأولى: العقيدة',
                    style: TextStyle(fontSize: 11, color: c.textMuted, fontWeight: FontWeight.normal)),
                const Text('الدرس الثالث — الإيمان باليوم الآخر والقضاء والقدر', style: TextStyle(fontSize: 17)),
              ],
            ),
          ),
          actions: [
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'بحمد الله وتوفيقه تم الدرس الثالث',
                                      ...
                                      children: [
                                        ElevatedButton.icon(
                                          onPressed: () => CelebrationDialog.show(
                                            context,
                                            title: 'أَحْسَنْتَ! 🎉',
                                            message: 'أَتْمَمْتَ الدَّرْسَ الثَّالِثَ: الْإِيمَانُ بِالْيَوْمِ الْآخِرِ وَالْقَضَاءِ وَالْقَدَرِ',
                                          ),
...
class _Hero3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final c = context.colors;
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('الْإِيمَانُ بِالْيَوْمِ الآخِرِ وَالْقَضَاءِ وَالْقَدَرِ',
              style: TextStyle(fontFamily: AppTheme.arabicFont, fontWeight: FontWeight.w800, fontSize: 28, color: c.accent)),
          const SizedBox(height: 6),
          ...
          const SizedBox(height: 14),
          for (final o in Dars113.objectives)
            Padding(

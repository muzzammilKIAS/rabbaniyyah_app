...
import '../widgets/dars_1_6/analyze_card.dart';
import '../widgets/dars_1_6/reading_card.dart';
import '../widgets/dars_1_6/reflection_exit_card.dart';
import '../widgets/dars_1_6/rule_card.dart';
import '../widgets/dars_1_6/speaking_card.dart';
...
class Dars116Screen extends StatelessWidget {
    ...
    return LessonShell(
      ...
      sections: const [
        LessonSection(
          ...
          children: [ReadingCard6()],
        ),
        LessonSection(
          step: 'كلمات وقاعدة',
          divider: 'جدول الكلمات والقاعدة',
          icon: Icons.view_list_outlined,
          children: [VocabCard6(), RuleCard6()],
        ),
        LessonSection(
          step: 'أتكلم',
          divider: 'أتكلم باللغة العربية',
          icon: Icons.forum_outlined,
          children: [SpeakingCard6()],
        ),
        LessonSection(
          step: 'أفكر وأكتب',
          divider: 'أفكر وأكتب',
          icon: Icons.edit_note_outlined,
          children: [ThinkWriteCard6()],
        ),
        LessonSection(
          step: 'أحلل وأطبق',
          divider: 'أحلل وأطبق',
          icon: Icons.groups_outlined,
          children: [AnalyzeCard6()],
        ),
        LessonSection(
          step: 'الفقه والحياة',
          divider: 'الفقه والحياة',
          icon: Icons.favorite_border,
          children: [ReflectionCard6()],
        ),
        LessonSection(
          step: 'الخاتمة',
          divider: 'الخاتمة',
          icon: Icons.flag_outlined,
          children: [ExitTicketCard6(), SelfAssessCard6(), SizedBox(height: 12), DictionaryCard6()],
        ),
      ],
      closingTitle: 'بحمد الله وتوفيقه تم الدرس السادس',
      celebrationTitle: 'أَحْسَنْتَ! 🎉',
      celebrationMessage: 'أَتْمَمْتَ الدَّرْسَ السَّادِسَ: صِيَامُ رَمَضَانَ',
    );
  }
}

class _Hero6 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'صِيَامُ رَمَضَانَ: الشُّرُوطُ، الأَرْكَانُ، وَالمُبْطِلَاتُ',
            style: TextStyle(
          ...
          const SizedBox(height: 14),
          for (final o in Dars116.objectives)
            Padding(

...
class Dars116Screen extends StatefulWidget {
  ...
  @override
  State<Dars116Screen> createState() => _Dars116ScreenState();
}

class _Dars116ScreenState extends State<Dars116Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    final progress = app.dars116Progress(Dars116.selfAssessItems.length);
          ...
          title: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('الدرس السادس — صيام رمضان', style: TextStyle(fontSize: 17)),
              ],
            ),
          ),
          actions: [
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'بحمد الله وتوفيقه تم الدرس السادس',
                                      ...
                                      children: [
                                        ElevatedButton.icon(
                                          onPressed: () => CelebrationDialog.show(
                                            context,
                                            title: 'أَحْسَنْتَ! 🎉',
                                            message: 'أَتْمَمْتَ الدَّرْسَ السَّادِسَ: صِيَامُ رَمَضَانَ',
                                          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('صِيَامُ رَمَضَانَ: الشُّرُوطُ، الأَرْكَانُ، وَالمُبْطِلَاتُ',

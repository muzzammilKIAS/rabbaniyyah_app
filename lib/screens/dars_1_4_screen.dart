...
class Dars114Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LessonShell(
      ...
      title: 'الدرس الرابع — الطهارة: الوضوء والغسل',
      hero: _Hero4(),
      sections: const [
        LessonSection(
          step: 'أقرأ وأفهم',
          ...
          children: [ReadingCard4()],
        ),
        LessonSection(
          step: 'كلمات وقاعدة',
          divider: 'جدول الكلمات والقاعدة',
          icon: Icons.view_list_outlined,
          children: [VocabCard4(), RuleCard4()],
        ),
        LessonSection(
          step: 'أتكلم',
          divider: 'أتكلم باللغة العربية',
          icon: Icons.forum_outlined,
          children: [SpeakingCard4()],
        ),
        LessonSection(
          step: 'أفكر وأكتب',
          divider: 'أفكر وأكتب',
          icon: Icons.edit_note_outlined,
          children: [ThinkWriteCard4()],
        ),
        LessonSection(
          step: 'أحلل وأطبق',
          divider: 'أحلل وأطبق',
          icon: Icons.groups_outlined,
          children: [AnalyzeCard4()],
        ),
        LessonSection(
          step: 'الفقه والحياة',
          divider: 'الفقه والحياة',
          icon: Icons.favorite_border,
          children: [ReflectionCard4()],
        ),
        LessonSection(
          step: 'الخاتمة',
          divider: 'الخاتمة',
          icon: Icons.flag_outlined,
          children: [ExitTicketCard4(), SelfAssessCard4(), SizedBox(height: 12), DictionaryCard4()],
        ),
      ],
      closingTitle: 'بحمد الله وتوفيقه تم الدرس الرابع',
      celebrationTitle: 'أَحْسَنْتَ! 🎉',
      celebrationMessage: 'أَتْمَمْتَ الدَّرْسَ الرَّابِعَ: الطَّهَارَةُ — الوُضُوءُ وَالغُسْلُ',
    );
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'الطَّهَارَةُ: الوُضُوءُ وَالغُسْلُ',
            style: TextStyle(

...
class Dars1112Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LessonShell(
      ...
      title: 'الدرس الثاني عشر — الصحابة المختارون وإسهاماتهم',
      hero: _Hero12(),
      sections: const [
        LessonSection(
          step: 'أقرأ وأفهم',
          ...
          children: [ReadingCard12()],
        ),
        LessonSection(
          step: 'كلمات وقاعدة',
          divider: 'جدول الكلمات والقاعدة',
          icon: Icons.view_list_outlined,
          children: [VocabCard12(), RuleCard12()],
        ),
        LessonSection(
          step: 'أتكلم',
          divider: 'أتكلم باللغة العربية',
          icon: Icons.forum_outlined,
          children: [SpeakingCard12()],
        ),
        LessonSection(
          step: 'أفكر وأكتب',
          divider: 'أفكر وأكتب',
          icon: Icons.edit_note_outlined,
          children: [ThinkWriteCard12()],
        ),
        LessonSection(
          step: 'أحلل وأطبق',
          divider: 'أحلل وأطبق',
          icon: Icons.groups_outlined,
          children: [AnalyzeCard12()],
        ),
        LessonSection(
          step: 'السيرة والحياة',
          divider: 'السيرة والحياة',
          icon: Icons.favorite_border,
          children: [ReflectionCard12()],
        ),
        LessonSection(
          step: 'الخاتمة',
          divider: 'الخاتمة',
          icon: Icons.flag_outlined,
          children: [ExitTicketCard12(), SelfAssessCard12(), SizedBox(height: 12), DictionaryCard12()],
        ),
      ],
      closingTitle: 'بحمد الله وتوفيقه تم الدرس الثاني عشر',
      celebrationTitle: 'أَحْسَنْتَ! 🎉',
      celebrationMessage: 'أَتْمَمْتَ الدَّرْسَ الثَّانِيَ عَشَرَ: الصَّحَابَةُ الْمُخْتَارُونَ وَإِسْهَامَاتُهُمْ',
    );
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'الصَّحَابَةُ الْمُخْتَارُونَ وَإِسْهَامَاتُهُمْ',
            style: TextStyle(

...
class Dars112Screen extends StatefulWidget {
  ...
  @override
  State<Dars112Screen> createState() => _Dars112ScreenState();
}

class _Dars112ScreenState extends State<Dars112Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    final progress = app.dars112Progress(Dars112.selfAssessItems.length);
          ...
          title: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('الدرس الثاني — الإيمان بالملائكة والكتب والرسل', style: TextStyle(fontSize: 17)),
              ],
            ),
          ),
          actions: [
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'بحمد الله وتوفيقه تم الدرس الثاني',
                                      ...
                                      children: [
                                        ElevatedButton.icon(
                                          onPressed: () => CelebrationDialog.show(
                                            context,
                                            title: 'أَحْسَنْتَ! 🎉',
                                            message: 'أَتْمَمْتَ الدَّرْسَ الثَّانِي: الْإِيمَانُ بِالْمَلَائِكَةِ وَالْكُتُبِ وَالرُّسُلِ',
                                          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('الْإِيمَانُ بِالْمَلَائِكَةِ وَالْكُتُبِ وَالرُّسُلِ',

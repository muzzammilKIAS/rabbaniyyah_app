...
class Dars1111Screen extends StatefulWidget {
  ...
  @override
  State<Dars1111Screen> createState() => _Dars1111ScreenState();
}

class _Dars1111ScreenState extends State<Dars1111Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    final progress = app.dars1111Progress(Dars1111.selfAssessItems.length);
          ...
          title: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('الدرس الحادي عشر — الإسراء والمعراج والهجرة', style: TextStyle(fontSize: 17)),
              ],
            ),
          ),
          actions: [
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'بحمد الله وتوفيقه تم الدرس الحادي عشر',
                                      ...
                                      children: [
                                        ElevatedButton.icon(
                                          onPressed: () => CelebrationDialog.show(
                                            context,
                                            title: 'أَحْسَنْتَ! 🎉',
                                            message: 'أَتْمَمْتَ الدَّرْسَ الْحَادِيَ عَشَرَ: الْإِسْرَاءُ وَالْمِعْرَاجُ وَالْهِجْرَةُ',
                                          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('الْإِسْرَاءُ وَالْمِعْرَاجُ وَالْهِجْرَةُ',

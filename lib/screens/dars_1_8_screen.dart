...
class Dars118Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LessonShell(
      ...
      title: 'الدرس الثامن — الأخلاق مع الله ورسوله',
      hero: _Hero8(),
      sections: const [
        LessonSection(
          step: 'أقرأ وأفهم',
          ...
          children: [ReadingCard8()],
        ),
        LessonSection(
          step: 'كلمات وقاعدة',
          divider: 'جدول الكلمات والقاعدة',
          icon: Icons.view_list_outlined,
          children: [VocabCard8(), RuleCard8()],
        ),
        LessonSection(
          step: 'أتكلم',
          divider: 'أتكلم باللغة العربية',
          icon: Icons.forum_outlined,
          children: [SpeakingCard8()],
        ),
        LessonSection(
          step: 'أفكر وأكتب',
          divider: 'أفكر وأكتب',
          icon: Icons.edit_note_outlined,
          children: [ThinkWriteCard8()],
        ),
        LessonSection(
          step: 'أحلل وأطبق',
          divider: 'أحلل وأطبق',
          icon: Icons.groups_outlined,
          children: [AnalyzeCard8()],
        ),
        LessonSection(
          step: 'الأخلاق والحياة',
          divider: 'الأخلاق والحياة',
          icon: Icons.favorite_border,
          children: [ReflectionCard8()],
        ),
        LessonSection(
          step: 'الخاتمة',
          divider: 'الخاتمة',
          icon: Icons.flag_outlined,
          children: [ExitTicketCard8(), SelfAssessCard8(), SizedBox(height: 12), DictionaryCard8()],
        ),
      ],
      closingTitle: 'بحمد الله وتوفيقه تم الدرس الثامن',
      celebrationTitle: 'أَحْسَنْتَ! 🎉',
      celebrationMessage: 'أَتْمَمْتَ الدَّرْسَ الثَّامِنَ: الْأَخْلَاقُ مَعَ اللهِ وَرَسُولِهِ',
    );
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'الأَخْلَاقُ مَعَ اللهِ وَرَسُولِهِ',
            style: TextStyle(

...
import '../widgets/dars_1_8/analyze_card.dart';
import '../widgets/dars_1_8/reading_card.dart';
import '../widgets/dars_1_8/reflection_exit_card.dart';
import '../widgets/dars_1_8/rule_card.dart';
import '../widgets/dars_1_8/speaking_card.dart';
import '../widgets/dars_1_8/think_write_card.dart';
import '../widgets/dars_1_8/vocab_card.dart';
...
class Dars118Screen extends StatefulWidget {
  const Dars118Screen({super.key});

  @override
  State<Dars118Screen> createState() => _Dars118ScreenState();
}

class _Dars118ScreenState extends State<Dars118Screen> {
  ...
  late final _slides = [
    ProjectorSlide(
      label: 'الدرس الثامن — الأخلاق مع الله ورسوله',
      icon: Icons.auto_stories_rounded,
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        _Hero8(),
        const TopicIntroVideo(assetPath: 'assets/video/topik8.mp4'),
      ]),
    ),
    ProjectorSlide(
      label: 'أقرأ وأفهم',
    ...
    ProjectorSlide(
      ...
      child: Column(children: [
        ...
        const ExitTicketCard8(),
        const SelfAssessCard8(),
        const SizedBox(height: 12),
        const DictionaryCard8(),
      ]),
    ),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    final progress = app.dars118Progress(Dars118.selfAssessItems.length);
          ...
          title: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('الدرس الثامن — الأخلاق مع الله ورسوله', style: TextStyle(fontSize: 17)),
              ],
            ),
          ),
          actions: [
            ...
            IconButton(
              ...
              onPressed: () => ProjectorModeView.open(
                context,
                lessonTitle: 'الدرس الثامن — الأخلاق مع الله ورسوله',
                slides: _slides,
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'بحمد الله وتوفيقه تم الدرس الثامن',
                                      ...
                                      children: [
                                        ElevatedButton.icon(
                                          onPressed: () => CelebrationDialog.show(
                                            context,
                                            title: 'أَحْسَنْتَ! 🎉',
                                            message: 'أَتْمَمْتَ الدَّرْسَ الثَّامِنَ: الْأَخْلَاقُ مَعَ اللهِ وَرَسُولِهِ',
                                          ),
...
class _Hero8 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final c = context.colors;
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('الأَخْلَاقُ مَعَ اللهِ وَرَسُولِهِ',
          ...
          const SizedBox(height: 14),
          for (final o in Dars118.objectives)
            Padding(

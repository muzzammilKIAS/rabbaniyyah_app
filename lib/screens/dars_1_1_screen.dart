...
class Dars111Screen extends StatefulWidget {
  ...
  @override
  State<Dars111Screen> createState() => _Dars111ScreenState();
}

class _Dars111ScreenState extends State<Dars111Screen> {
  final _readingKey = GlobalKey();
  final _vocabKey = GlobalKey();
  final _matchingKey = GlobalKey();
  ...
  late final _steps = [
    ...
    LessonStepItem(icon: Icons.forum_outlined, label: 'أتكلم', sectionKey: _matchingKey),
    LessonStepItem(icon: Icons.edit_note_outlined, label: 'أفكر وأكتب', sectionKey: _fillKey),
    LessonStepItem(icon: Icons.swap_horiz_outlined, label: 'أكتب وأحول', sectionKey: _transformKey),
  ...
  Widget build(BuildContext context) {
    ...
    final progress = app.dars111Progress(Dars111.selfAssessItems.length);
          ...
          title: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('الدرس الأول — الإيمان بالله', style: TextStyle(fontSize: 17)),
              ],
            ),
          ),
          actions: [
            IconButton(
              ...
              icon: Text(
                ...
                style: TextStyle(
                  ...
                  fontSize: 18,
                  color: app.tashkeelOn ? c.accent : c.textMuted,
                ),
              ),
            ),
            IconButton(
          ...
          child: SafeArea(
            child: Center(
              child: ConstrainedBox(
                ...
                child: Column(
                  children: [
                    // Sticky quick navigation rail pinned at top of the screen
                    Container(
                      ...
                      child: LessonStepRail(
                        items: _steps,
                        activeIndex: _active,
                        onTapItem: _scrollToIndex,
                      ),
                    ),
                    Expanded(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'بحمد الله وتوفيقه تم الدرس الأول',
                                          style: TextStyle(

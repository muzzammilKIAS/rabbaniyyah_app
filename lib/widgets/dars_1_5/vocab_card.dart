...
class VocabCard5 extends StatefulWidget {
  const VocabCard5({super.key});

  @override
  State<VocabCard5> createState() => _VocabCard5State();
}

class _VocabCard5State extends State<VocabCard5> {
  ...
  void initState() {
    ...
    _controllers = List.generate(
      Dars115.vocab.length,
      (i) => TextEditingController(text: app.dars115Get('vocab$i', '')),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Table(
            ...
            children: [
              for (var i = 0; i < Dars115.vocab.length; i++)
                TableRow(
                  ...
                  children: [
                        ...
                        children: [
                          SpeakButton(
                            ...
                            onTap: () async {
                              ...
                              await tts.speak(Dars115.vocab[i].word);
                    ...
                    Padding(
                      ...
                      child: Text(Dars115.vocab[i].meaning, style: TextStyle(fontSize: 13, color: c.textMuted, fontWeight: FontWeight.w500)),
                    ),
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (v) => context.read<AppState>().dars115Set('vocab$i', v),
                      ),
                    ),
                  ],
                ),

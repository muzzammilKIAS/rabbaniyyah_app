...
class RuleCard5 extends StatelessWidget {
  const RuleCard5({super.key});
    ...
    return SectionCard(
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Expanded(child: CardHeading('💡 قَاعِدَةٌ: فِعْلُ الْأَمْرِ')),
              Container(
                ...
                child: Text('فِعْلُ الْأَمْرِ', style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w700, color: c.gold)),
              ),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(Dars115.ruleIntro, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
                const SizedBox(height: 10),
                Text(Dars115.ruleFormula,
                ...
                Text(Dars115.ruleExample, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
                const SizedBox(height: 6),
                Text(Dars115.ruleNote, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Row(
              children: [
                Expanded(child: Text('فِعْلُ الْأَمْرِ', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: c.textMuted))),
                Expanded(child: Text('أَصْلُهُ (مُضَارِعٌ ← مَاضٍ)', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: c.textMuted))),
          ...
          Table(
            ...
            children: [
              for (final row in Dars115.ruleTable)
                TableRow(

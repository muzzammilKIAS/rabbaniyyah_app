...
class SpeakingCard5 extends StatefulWidget {
  const SpeakingCard5({super.key});

  @override
  State<SpeakingCard5> createState() => _SpeakingCard5State();
}

class _SpeakingCard5State extends State<SpeakingCard5> {
  ...
  void initState() {
    super.initState();
    final raw = context.read<AppState>().dars115Get<Map<String, dynamic>>('speakingPairs', {});
    raw.forEach((k, v) => _pairs[int.parse(k)] = v as int);
  }

  void _save() {
    context.read<AppState>().dars115Set('speakingPairs', _pairs.map((k, v) => MapEntry(k.toString(), v)));
  }

  void _check() {
    setState(() {
      _results = {
        for (final entry in _pairs.entries) entry.key: entry.value == Dars115.matchCorrectIndex[entry.key],
      };
    });
  }
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    for (var i = 0; i < Dars115.matchQuestions.length; i++)
                      _Chip4(
                        label: '${i + 1}) ${Dars115.matchQuestions[i]}',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    for (var i = 0; i < Dars115.matchAnswers.length; i++)
                      _Chip4(
                        label: '${Dars115.matchAnswerLetters[i]}) ${Dars115.matchAnswers[i]}',
                        selected: false,
          ...
          Row(
            children: [
              ...
              ScoreBadge(correct: correctCount, total: correctCount != null ? Dars115.matchQuestions.length : null),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                for (var i = 0; i < Dars115.dialogue.length; i++)
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(Dars115.dialogue[i].studentB,
                        ...
                        Expanded(
                          child: Text(Dars115.dialogue[i].studentA,
                              textAlign: TextAlign.center,

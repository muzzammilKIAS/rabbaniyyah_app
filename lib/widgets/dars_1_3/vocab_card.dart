...
class VocabCard3 extends StatefulWidget {
  const VocabCard3({super.key});

  @override
  State<VocabCard3> createState() => _VocabCard3State();
}

class _VocabCard3State extends State<VocabCard3> {
  ...
  void initState() {
    ...
    _controllers = List.generate(Dars113.vocab.length, (i) => TextEditingController(text: app.dars113Get('vocab$i', '')));
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Table(
            ...
            children: [
              for (var i = 0; i < Dars113.vocab.length; i++)
                TableRow(
                  ...
                  children: [
                        ...
                        children: [
                          SpeakButton(
                            ...
                            onTap: () async {
                              ...
                              await tts.speak(Dars113.vocab[i].word);
                              if (mounted && _speaking == i) setState(() => _speaking = null);
                            },
                          ),
                          const SizedBox(width: 8),
                          Expanded(
                            child: Text(Dars113.vocab[i].word,
                    ...
                    Padding(
                      ...
                      child: Text(Dars113.vocab[i].meaning, style: TextStyle(fontSize: 13, color: c.textMuted, fontWeight: FontWeight.w500)),
                    ),
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (v) => context.read<AppState>().dars113Set('vocab$i', v),
                      ),
                    ),
                  ],
                ),

...
class _ReadingCard3State extends State<ReadingCard3> {
  ...
  Future<void> _speakLine(int i) async {
    if (!TtsService.canSpeak(Dars113.readingLines[i])) return;
  ...
  Future<void> _playAll() async {
    ...
    for (var i = 0; i < Dars113.readingLines.length; i++) {
      ...
      if (!TtsService.canSpeak(Dars113.readingLines[i])) continue;
      setState(() => _speakingLine = i);
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  if (!TtsService.canSpeak(Dars113.readingLines[i]))

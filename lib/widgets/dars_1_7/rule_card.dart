...
class RuleCard7 extends StatelessWidget {
  const RuleCard7({super.key});
    ...
    return SectionCard(
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Expanded(child: CardHeading('💡 قَاعِدَةٌ: اِسْمٌ + صِفَةٌ')),
              Container(
                ...
                child: Text('اِسْمٌ + صِفَةٌ', style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w700, color: c.gold)),
              ),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(Dars117.ruleIntro, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
                const SizedBox(height: 10),
                Text(Dars117.ruleFormula,
                ...
                Text(Dars117.ruleExample, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
                const SizedBox(height: 6),
                Text(Dars117.ruleNote, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Row(
              children: [
                Expanded(child: Text('الِاسْمُ', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: c.textMuted))),
          ...
          Table(
            ...
            children: [
              for (final row in Dars117.ruleTable)
                TableRow(

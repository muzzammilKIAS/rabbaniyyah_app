...
class SpeakingCard7 extends StatefulWidget {
  const SpeakingCard7({super.key});

  @override
  State<SpeakingCard7> createState() => _SpeakingCard7State();
}

class _SpeakingCard7State extends State<SpeakingCard7> {
  ...
  void initState() {
    super.initState();
    final raw = context.read<AppState>().dars117Get<Map<String, dynamic>>('speakingPairs', {});
    raw.forEach((k, v) => _pairs[int.parse(k)] = v as int);
  }

  void _save() {
    context.read<AppState>().dars117Set('speakingPairs', _pairs.map((k, v) => MapEntry(k.toString(), v)));
  }

  void _check() {
    setState(() {
      _results = {
        for (final entry in _pairs.entries) entry.key: entry.value == Dars117.matchCorrectIndex[entry.key],
      };
    });
  }
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    for (var i = 0; i < Dars117.matchQuestions.length; i++)
                      _Chip4(
                        label: '${i + 1}) ${Dars117.matchQuestions[i]}',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    for (var i = 0; i < Dars117.matchAnswers.length; i++)
                      _Chip4(
                        label: '${Dars117.matchAnswerLetters[i]}) ${Dars117.matchAnswers[i]}',
                        selected: false,
          ...
          Row(
            children: [
              ...
              ScoreBadge(correct: correctCount, total: correctCount != null ? Dars117.matchQuestions.length : null),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                for (var i = 0; i < Dars117.dialogue.length; i++)
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(Dars117.dialogue[i].studentB,
                        ...
                        Expanded(
                          child: Text(Dars117.dialogue[i].studentA,
                              textAlign: TextAlign.center,

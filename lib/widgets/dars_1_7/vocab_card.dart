...
class VocabCard7 extends StatefulWidget {
  const VocabCard7({super.key});

  @override
  State<VocabCard7> createState() => _VocabCard7State();
}

class _VocabCard7State extends State<VocabCard7> {
  ...
  void initState() {
    ...
    _controllers = List.generate(
      Dars117.vocab.length,
      (i) => TextEditingController(text: app.dars117Get('vocab$i', '')),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Table(
            ...
            children: [
              for (var i = 0; i < Dars117.vocab.length; i++)
                TableRow(
                  ...
                  children: [
                        ...
                        children: [
                          SpeakButton(
                            ...
                            onTap: () async {
                              ...
                              await tts.speak(Dars117.vocab[i].word);
                    ...
                    Padding(
                      ...
                      child: Text(Dars117.vocab[i].meaning, style: TextStyle(fontSize: 13, color: c.textMuted, fontWeight: FontWeight.w500)),
                    ),
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (v) => context.read<AppState>().dars117Set('vocab$i', v),
                      ),
                    ),
                  ],
                ),

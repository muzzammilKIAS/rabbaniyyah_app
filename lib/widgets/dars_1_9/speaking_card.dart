...
class SpeakingCard9 extends StatefulWidget {
  const SpeakingCard9({super.key});

  @override
  State<SpeakingCard9> createState() => _SpeakingCard9State();
}

class _SpeakingCard9State extends State<SpeakingCard9> {
  ...
  void initState() {
    super.initState();
    final raw = context.read<AppState>().dars119Get<Map<String, dynamic>>('speakingPairs', {});
    raw.forEach((k, v) => _pairs[int.parse(k)] = v as int);
  }

  void _save() {
    context.read<AppState>().dars119Set('speakingPairs', _pairs.map((k, v) => MapEntry(k.toString(), v)));
  }

  void _check() {
    setState(() {
      _results = {
        for (final entry in _pairs.entries) entry.key: entry.value == Dars119.matchCorrectIndex[entry.key],
      };
    });
  }
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    for (var i = 0; i < Dars119.matchQuestions.length; i++)
                      _Chip4(
                        label: '${i + 1}) ${Dars119.matchQuestions[i]}',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    for (var i = 0; i < Dars119.matchAnswers.length; i++)
                      _Chip4(
                        label: '${Dars119.matchAnswerLetters[i]}) ${Dars119.matchAnswers[i]}',
                        selected: false,
          ...
          Row(
            children: [
              ...
              ScoreBadge(correct: correctCount, total: correctCount != null ? Dars119.matchQuestions.length : null),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                for (var i = 0; i < Dars119.dialogue.length; i++)
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(Dars119.dialogue[i].studentB,
                        ...
                        Expanded(
                          child: Text(Dars119.dialogue[i].studentA,
                              textAlign: TextAlign.center,

...
class VocabCard9 extends StatefulWidget {
  const VocabCard9({super.key});

  @override
  State<VocabCard9> createState() => _VocabCard9State();
}

class _VocabCard9State extends State<VocabCard9> {
  ...
  void initState() {
    ...
    _controllers = List.generate(
      Dars119.vocab.length,
      (i) => TextEditingController(text: app.dars119Get('vocab$i', '')),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Table(
            ...
            children: [
              for (var i = 0; i < Dars119.vocab.length; i++)
                TableRow(
                  ...
                  children: [
                        ...
                        children: [
                          SpeakButton(
                            ...
                            onTap: () async {
                              ...
                              await tts.speak(Dars119.vocab[i].word);
                    ...
                    Padding(
                      ...
                      child: Text(Dars119.vocab[i].meaning, style: TextStyle(fontSize: 13, color: c.textMuted, fontWeight: FontWeight.w500)),
                    ),
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (v) => context.read<AppState>().dars119Set('vocab$i', v),
                      ),
                    ),
                  ],
                ),

    ...
    return SectionCard(
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Expanded(child: CardHeading('💡 قَاعِدَةٌ: كَلِمَاتُ التَّرْتِيبِ')),
              Container(
                ...
                child: Text('كَلِمَاتُ التَّرْتِيبِ', style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w700, color: c.gold)),
              ),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(Dars114.ruleIntro, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
                const SizedBox(height: 10),
                Text(Dars114.ruleFormula,
                ...
                Text(Dars114.ruleExample, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
                const SizedBox(height: 6),
                Text(Dars114.ruleNote, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Row(
              children: [
                Expanded(child: Text('كَلِمَةُ التَّرْتِيبِ', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: c.textMuted))),
                Expanded(child: Text('الجُمْلَةُ', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: c.textMuted))),
          ...
          Table(
            ...
            children: [
              for (final row in Dars114.ruleTable)
                TableRow(

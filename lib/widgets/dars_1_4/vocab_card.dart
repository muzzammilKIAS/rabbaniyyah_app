...
class VocabCard4 extends StatefulWidget {
  const VocabCard4({super.key});

  @override
  State<VocabCard4> createState() => _VocabCard4State();
}

class _VocabCard4State extends State<VocabCard4> {
  ...
  void initState() {
    ...
    _controllers = List.generate(
      Dars114.vocab.length,
      (i) => TextEditingController(text: app.dars114Get('vocab$i', '')),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Table(
            ...
            children: [
              for (var i = 0; i < Dars114.vocab.length; i++)
                TableRow(
                  ...
                  children: [
                        ...
                        children: [
                          SpeakButton(
                            ...
                            onTap: () async {
                              ...
                              await tts.speak(Dars114.vocab[i].word);
                    ...
                    Padding(
                      ...
                      child: Text(Dars114.vocab[i].meaning, style: TextStyle(fontSize: 13, color: c.textMuted, fontWeight: FontWeight.w500)),
                    ),
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (v) => context.read<AppState>().dars114Set('vocab$i', v),
                      ),
                    ),
                  ],
                ),

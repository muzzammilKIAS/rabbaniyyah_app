...
class SpeakingCard12 extends StatefulWidget {
  const SpeakingCard12({super.key});

  @override
  State<SpeakingCard12> createState() => _SpeakingCard12State();
}

class _SpeakingCard12State extends State<SpeakingCard12> {
  ...
  void initState() {
    super.initState();
    final raw = context.read<AppState>().dars1112Get<Map<String, dynamic>>('speakingPairs', {});
    raw.forEach((k, v) => _pairs[int.parse(k)] = v as int);
  }

  void _save() {
    context.read<AppState>().dars1112Set('speakingPairs', _pairs.map((k, v) => MapEntry(k.toString(), v)));
  }

  void _check() {
    setState(() {
      _results = {
        for (final entry in _pairs.entries) entry.key: entry.value == Dars1112.matchCorrectIndex[entry.key],
      };
    });
  }
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    for (var i = 0; i < Dars1112.matchQuestions.length; i++)
                      _Chip4(
                        label: '${i + 1}) ${Dars1112.matchQuestions[i]}',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    for (var i = 0; i < Dars1112.matchAnswers.length; i++)
                      _Chip4(
                        label: '${Dars1112.matchAnswerLetters[i]}) ${Dars1112.matchAnswers[i]}',
                        selected: false,
          ...
          Row(
            children: [
              ...
              ScoreBadge(correct: correctCount, total: correctCount != null ? Dars1112.matchQuestions.length : null),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                for (var i = 0; i < Dars1112.dialogue.length; i++)
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(Dars1112.dialogue[i].studentB,
                        ...
                        Expanded(
                          child: Text(Dars1112.dialogue[i].studentA,
                              textAlign: TextAlign.center,

...
class VocabCard12 extends StatefulWidget {
  const VocabCard12({super.key});

  @override
  State<VocabCard12> createState() => _VocabCard12State();
}

class _VocabCard12State extends State<VocabCard12> {
  ...
  void initState() {
    ...
    _controllers = List.generate(
      Dars1112.vocab.length,
      (i) => TextEditingController(text: app.dars1112Get('vocab$i', '')),
    );
  }
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ...
              Container(
                ...
                child: Text('١٢ مفردات', style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.bold, color: c.accent)),
              ),
            ],
          ),
          ...
          Table(
            ...
            children: [
              for (var i = 0; i < Dars1112.vocab.length; i++)
                TableRow(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(Dars1112.vocab[i].meaning, style: TextStyle(fontSize: 13, color: c.textMuted, fontWeight: FontWeight.w500)),
                    ),
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (v) => context.read<AppState>().dars1112Set('vocab$i', v),
                      ),
                    ),
                  ],
                ),

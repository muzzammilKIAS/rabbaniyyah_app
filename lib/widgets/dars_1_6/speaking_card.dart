...
class SpeakingCard6 extends StatefulWidget {
  const SpeakingCard6({super.key});

  @override
  State<SpeakingCard6> createState() => _SpeakingCard6State();
}

class _SpeakingCard6State extends State<SpeakingCard6> {
  ...
  void initState() {
    super.initState();
    final raw = context.read<AppState>().dars116Get<Map<String, dynamic>>('speakingPairs', {});
    raw.forEach((k, v) => _pairs[int.parse(k)] = v as int);
  }

  void _save() {
    context.read<AppState>().dars116Set('speakingPairs', _pairs.map((k, v) => MapEntry(k.toString(), v)));
  }

  void _check() {
    setState(() {
      _results = {
        for (final entry in _pairs.entries) entry.key: entry.value == Dars116.matchCorrectIndex[entry.key],
      };
    });
  }
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    for (var i = 0; i < Dars116.matchQuestions.length; i++)
                      _Chip4(
                        label: '${i + 1}) ${Dars116.matchQuestions[i]}',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    for (var i = 0; i < Dars116.matchAnswers.length; i++)
                      _Chip4(
                        label: '${Dars116.matchAnswerLetters[i]}) ${Dars116.matchAnswers[i]}',
                        selected: false,
          ...
          Row(
            children: [
              ...
              ScoreBadge(correct: correctCount, total: correctCount != null ? Dars116.matchQuestions.length : null),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                for (var i = 0; i < Dars116.dialogue.length; i++)
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(Dars116.dialogue[i].studentB,
                        ...
                        Expanded(
                          child: Text(Dars116.dialogue[i].studentA,
                              textAlign: TextAlign.center,

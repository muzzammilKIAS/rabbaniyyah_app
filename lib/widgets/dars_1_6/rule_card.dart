...
class RuleCard6 extends StatelessWidget {
  const RuleCard6({super.key});
    ...
    return SectionCard(
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Expanded(child: CardHeading('💡 قَاعِدَةٌ: أُسْلُوبُ النَّهْيِ')),
              Container(
                ...
                child: Text('أُسْلُوبُ النَّهْيِ', style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w700, color: c.gold)),
              ),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(Dars116.ruleIntro, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
                const SizedBox(height: 10),
                Text(Dars116.ruleFormula,
                ...
                Text(Dars116.ruleExample, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
                const SizedBox(height: 6),
                Text(Dars116.ruleNote, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Row(
              children: [
                Expanded(child: Text('صِيغَةُ النَّهْيِ', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: c.textMuted))),
                Expanded(child: Text('التَّحْلِيلُ', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: c.textMuted))),
          ...
          Table(
            ...
            children: [
              for (final row in Dars116.ruleTable)
                TableRow(

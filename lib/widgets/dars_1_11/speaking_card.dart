...
class SpeakingCard11 extends StatefulWidget {
  const SpeakingCard11({super.key});

  @override
  State<SpeakingCard11> createState() => _SpeakingCard11State();
}

class _SpeakingCard11State extends State<SpeakingCard11> {
  ...
  void initState() {
    super.initState();
    final raw = context.read<AppState>().dars1111Get<Map<String, dynamic>>('speakingPairs', {});
    raw.forEach((k, v) => _pairs[int.parse(k)] = v as int);
  }

  void _save() {
    context.read<AppState>().dars1111Set('speakingPairs', _pairs.map((k, v) => MapEntry(k.toString(), v)));
  }

  void _check() {
    setState(() {
      _results = {
        for (final entry in _pairs.entries) entry.key: entry.value == Dars1111.matchCorrectIndex[entry.key],
      };
    });
  }
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    for (var i = 0; i < Dars1111.matchQuestions.length; i++)
                      _Chip4(
                        label: '${i + 1}) ${Dars1111.matchQuestions[i]}',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    for (var i = 0; i < Dars1111.matchAnswers.length; i++)
                      _Chip4(
                        label: '${Dars1111.matchAnswerLetters[i]}) ${Dars1111.matchAnswers[i]}',
                        selected: false,
          ...
          Row(
            children: [
              ...
              ScoreBadge(correct: correctCount, total: correctCount != null ? Dars1111.matchQuestions.length : null),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                for (var i = 0; i < Dars1111.dialogue.length; i++)
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(Dars1111.dialogue[i].studentB,
                        ...
                        Expanded(
                          child: Text(Dars1111.dialogue[i].studentA,
                              textAlign: TextAlign.center,

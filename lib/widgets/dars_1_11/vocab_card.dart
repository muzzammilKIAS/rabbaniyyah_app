...
class VocabCard11 extends StatefulWidget {
  const VocabCard11({super.key});

  @override
  State<VocabCard11> createState() => _VocabCard11State();
}

class _VocabCard11State extends State<VocabCard11> {
  ...
  void initState() {
    ...
    _controllers = List.generate(
      Dars1111.vocab.length,
      (i) => TextEditingController(text: app.dars1111Get('vocab$i', '')),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Table(
            ...
            children: [
              for (var i = 0; i < Dars1111.vocab.length; i++)
                TableRow(
                  ...
                  children: [
                        ...
                        children: [
                          SpeakButton(
                            ...
                            onTap: () async {
                              ...
                              await tts.speak(Dars1111.vocab[i].word);
                    ...
                    Padding(
                      ...
                      child: Text(Dars1111.vocab[i].meaning, style: TextStyle(fontSize: 13, color: c.textMuted, fontWeight: FontWeight.w500)),
                    ),
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (v) => context.read<AppState>().dars1111Set('vocab$i', v),
                      ),
                    ),
                  ],
                ),

...
class SpeakingCard10 extends StatefulWidget {
  const SpeakingCard10({super.key});

  @override
  State<SpeakingCard10> createState() => _SpeakingCard10State();
}

class _SpeakingCard10State extends State<SpeakingCard10> {
  ...
  void initState() {
    super.initState();
    final raw = context.read<AppState>().dars1110Get<Map<String, dynamic>>('speakingPairs', {});
    raw.forEach((k, v) => _pairs[int.parse(k)] = v as int);
  }

  void _save() {
    context.read<AppState>().dars1110Set('speakingPairs', _pairs.map((k, v) => MapEntry(k.toString(), v)));
  }

  void _check() {
    setState(() {
      _results = {
        for (final entry in _pairs.entries) entry.key: entry.value == Dars1110.matchCorrectIndex[entry.key],
      };
    });
  }
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    for (var i = 0; i < Dars1110.matchQuestions.length; i++)
                      _Chip4(
                        label: '${i + 1}) ${Dars1110.matchQuestions[i]}',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    for (var i = 0; i < Dars1110.matchAnswers.length; i++)
                      _Chip4(
                        label: '${Dars1110.matchAnswerLetters[i]}) ${Dars1110.matchAnswers[i]}',
                        selected: false,
          ...
          Row(
            children: [
              ...
              ScoreBadge(correct: correctCount, total: correctCount != null ? Dars1110.matchQuestions.length : null),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                for (var i = 0; i < Dars1110.dialogue.length; i++)
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(Dars1110.dialogue[i].studentB,
                        ...
                        Expanded(
                          child: Text(Dars1110.dialogue[i].studentA,
                              textAlign: TextAlign.center,

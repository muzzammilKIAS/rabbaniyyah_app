...
class VocabCard10 extends StatefulWidget {
  const VocabCard10({super.key});

  @override
  State<VocabCard10> createState() => _VocabCard10State();
}

class _VocabCard10State extends State<VocabCard10> {
  ...
  void initState() {
    ...
    _controllers = List.generate(
      Dars1110.vocab.length,
      (i) => TextEditingController(text: app.dars1110Get('vocab$i', '')),
    );
  }
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ...
              Container(
                ...
                child: Text('١٠ مفردات', style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.bold, color: c.accent)),
              ),
            ],
          ),
          ...
          Table(
            ...
            children: [
              for (var i = 0; i < Dars1110.vocab.length; i++)
                TableRow(
                  ...
                  children: [
                        ...
                        children: [
                          SpeakButton(
                            ...
                            onTap: () async {
                              ...
                              await tts.speak(Dars1110.vocab[i].word);
                    ...
                    Padding(
                      ...
                      child: Text(Dars1110.vocab[i].meaning, style: TextStyle(fontSize: 13, color: c.textMuted, fontWeight: FontWeight.w500)),
                    ),
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (v) => context.read<AppState>().dars1110Set('vocab$i', v),
                      ),
                    ),
                  ],
                ),

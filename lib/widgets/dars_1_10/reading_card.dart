...
class ReadingCard10 extends StatefulWidget {
  const ReadingCard10({super.key});

  @override
  State<ReadingCard10> createState() => _ReadingCard10State();
}

class _ReadingCard10State extends State<ReadingCard10> {
  int? _speakingLine;
  ...
  Future<void> _speakLine(int i) async {
    ...
    await tts.speak(Dars1110.readingLines[i]);
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('(${Dars1110.hadithSource})', style: TextStyle(fontSize: 12, color: c.textMuted)),
              ],
            ),
          ),
        ],

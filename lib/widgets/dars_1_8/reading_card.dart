...
class ReadingCard8 extends StatefulWidget {
  const ReadingCard8({super.key});

  @override
  State<ReadingCard8> createState() => _ReadingCard8State();
}

class _ReadingCard8State extends State<ReadingCard8> {
  int? _speakingLine;
  ...
  Future<void> _speakLine(int i) async {
    ...
    await tts.speak(Dars118.readingLines[i]);
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('(${Dars118.hadithSource})', style: TextStyle(fontSize: 12, color: c.textMuted)),
              ],
            ),
          ),
        ],

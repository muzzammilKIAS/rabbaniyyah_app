...
class VocabCard8 extends StatefulWidget {
  const VocabCard8({super.key});

  @override
  State<VocabCard8> createState() => _VocabCard8State();
}

class _VocabCard8State extends State<VocabCard8> {
  ...
  void initState() {
    ...
    _controllers = List.generate(
      Dars118.vocab.length,
      (i) => TextEditingController(text: app.dars118Get('vocab$i', '')),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Table(
            ...
            children: [
              for (var i = 0; i < Dars118.vocab.length; i++)
                TableRow(
                  ...
                  children: [
                        ...
                        children: [
                          SpeakButton(
                            ...
                            onTap: () async {
                              ...
                              await tts.speak(Dars118.vocab[i].word);
                    ...
                    Padding(
                      ...
                      child: Text(Dars118.vocab[i].meaning, style: TextStyle(fontSize: 13, color: c.textMuted, fontWeight: FontWeight.w500)),
                    ),
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onChanged: (v) => context.read<AppState>().dars118Set('vocab$i', v),
                      ),
                    ),
                  ],
                ),

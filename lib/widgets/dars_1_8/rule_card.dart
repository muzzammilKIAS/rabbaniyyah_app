...
class RuleCard8 extends StatelessWidget {
  const RuleCard8({super.key});
    ...
    return SectionCard(
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Expanded(child: CardHeading('💡 قَاعِدَةٌ: الجُمْلَةُ المُثْبَتَةُ وَالمَنْفِيَّةُ')),
              Container(
                ...
                child: Text('إِثْبَاتٌ وَنَفْيٌ', style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w700, color: c.gold)),
              ),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(Dars118.ruleIntro, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
                const SizedBox(height: 10),
                Text(Dars118.ruleFormula,
                ...
                Text(Dars118.ruleExample, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
                const SizedBox(height: 6),
                Text(Dars118.ruleNote, style: TextStyle(fontFamily: AppTheme.arabicFont, fontSize: 15, height: 1.8, color: c.text)),
              ],
            ),
          ),
          ...
          Table(
            ...
            children: [
              for (final row in Dars118.ruleTable)
                TableRow(

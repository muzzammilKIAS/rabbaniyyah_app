...
class SpeakingCard8 extends StatefulWidget {
  const SpeakingCard8({super.key});

  @override
  State<SpeakingCard8> createState() => _SpeakingCard8State();
}

class _SpeakingCard8State extends State<SpeakingCard8> {
  ...
  void initState() {
    super.initState();
    final raw = context.read<AppState>().dars118Get<Map<String, dynamic>>('speakingPairs', {});
    raw.forEach((k, v) => _pairs[int.parse(k)] = v as int);
  }

  void _save() {
    context.read<AppState>().dars118Set('speakingPairs', _pairs.map((k, v) => MapEntry(k.toString(), v)));
  }

  void _check() {
    setState(() {
      _results = {
        for (final entry in _pairs.entries) entry.key: entry.value == Dars118.matchCorrectIndex[entry.key],
      };
    });
  }
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    for (var i = 0; i < Dars118.matchQuestions.length; i++)
                      _Chip4(
                        label: '${i + 1}) ${Dars118.matchQuestions[i]}',
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    for (var i = 0; i < Dars118.matchAnswers.length; i++)
                      _Chip4(
                        label: '${Dars118.matchAnswerLetters[i]}) ${Dars118.matchAnswers[i]}',
                        selected: false,
          ...
          Row(
            children: [
              ...
              ScoreBadge(correct: correctCount, total: correctCount != null ? Dars118.matchQuestions.length : null),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                for (var i = 0; i < Dars118.dialogue.length; i++)
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(Dars118.dialogue[i].studentB,
                        ...
                        Expanded(
                          child: Text(Dars118.dialogue[i].studentA,
                              textAlign: TextAlign.center,
